...
<div>
	...
	<fieldset>
			...
			Subscriber Number: <font color="red"> <%=session.getAttribute("subscriber")%></font><br> 
			Frequent Call Type: <font color="red"> <%=session.getAttribute("description")%></font><br>
			Total units Consumed: <font color="red"> <%=session.getAttribute("totalUnits")%></font><br>
	</fieldset>
	</div>
	<div id="section">
	<fieldset>
			<legend>Current:</legend>
			Current Price Plan: <font color="red"> <%=session.getAttribute("currentpricePlan")%></font><br> 
			Bill amount of current plan: <font color="red"> <%=session.getAttribute("currentPrice")%></font> <br>
	</fieldset>
	</div>
	<div id="section">
	<fieldset>
			<legend>Proposed Price Plan:</legend>
			Proposed Price Plan: <font color="red"> <%=session.getAttribute("proposedPlan")%></font><br>
			Bill amount of Proposed plan: <font color="red"> <%=session.getAttribute("ProposedBill")%></font><br>
	</fieldset>
	</div>
</div>
<div id="footer">
